...
public final class StreamStore {
    ...
    public long xlen(String key) { return Resp.number(client.command("XLEN", key)); }
    public List<Object> xrange(String key, String start, String end) { return Resp.list(client.command("XRANGE", key, start, end)); }
